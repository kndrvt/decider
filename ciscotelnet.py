...
class CiscoTelnet(Telnet):
    ...
    def login(self, interactive=True, final_mode=MODE_ENABLE, user=None, user_pass=None, line_pass=None,
              enable_pass=None, max_steps=10):
        ...
        while True:
            ...
            username_pattern = re.compile(b"Username:", re.IGNORECASE)
            password_pattern = re.compile(b"Password:", re.IGNORECASE)
            exec_pattern = re.compile(b">", re.IGNORECASE)
            enable_pattern = re.compile(b"#", re.IGNORECASE)
            ...
            if answer[0] == 0:
                ...
                if self._mode == final_mode:
                    ...
                    self.write(b"terminal length 0\n")
