...
def run():
    ...
    # intf = Intf(name='enp0s3', node=r2, ip='10.0.6.5/24')
    ...
    r1.cmd(" 'sudo python DeciderClient.py' | xterm &")
    r1.cmd("xterm &")
    # h1.cmd("sleep 5")
    # h1.cmd("echo kek | faas-cli --gateway 10.0.8.51 invoke figlet")
